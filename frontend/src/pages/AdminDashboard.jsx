...
function InstagramTab({ token, onRefresh }) {
  ...
  if (loading) {
    return <div className="text-center py-12"><Loader2 size={32} className="animate-spin mx-auto text-[#E63329]" /></div>;
  }
        ...
        <DialogContent className="bg-white rounded-2xl border border-gray-200 shadow-2xl max-w-2xl">
          <DialogHeader>
            <DialogTitle className="title-massive text-2xl">
              {isCreating ? "Add" : "Edit"} Instagram Post<span className="text-[#E63329]">.</span>
            </DialogTitle>
          </DialogHeader>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  ...
                  className="text-xs font-mono uppercase tracking-wider text-[#E63329] hover:underline"
...
function SchedulesTab({ barbers, token }) {
  ...
  return (
    <div className="space-y-6" data-testid="schedules-tab">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="title-massive text-3xl">Availability<span className="text-[#E63329]">.</span></h2>
