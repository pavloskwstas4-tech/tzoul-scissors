...
import { LogOut, Trash2, Edit, Loader2, Calendar, User, Scissors, Clock, Plus, X, TrendingUp, DollarSign, Users, CalendarCheck } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
        <h3 className="title-massive text-2xl mb-4">Today's Appointments<span className="text-[#E63329]">.</span></h3>
          ...
          <div className="space-y-3">
            {todayBookings.sort((a, b) => a.time.localeCompare(b.time)).map((booking) => (
              <div key={booking.id} className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                <div className="px-3 py-2 bg-[#E63329] text-white rounded-lg font-mono text-sm font-bold">{booking.time}</div>
                ...
                <div className="text-right">
                  <div className="font-display text-lg text-[#E63329]">€{booking.price}</div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
          <h3 className="title-massive text-xl mb-4">Top Services<span className="text-[#E63329]">.</span></h3>
          <div className="space-y-3">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
          <h3 className="title-massive text-xl mb-4">Quick Stats<span className="text-[#E63329]">.</span></h3>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
        <div className="flex items-center justify-between mb-6">
          <h3 className="title-massive text-2xl">
            {barbers.find(b => b.id === selectedBarber)?.name}'s Schedule<span className="text-[#E63329]">.</span>
          </h3>
          ...
          {timeSlots.map(slot => {
            ...
            return (
              <div key={slot} className="flex items-stretch gap-3">
                ...
                {booking ? (
                  <div className="flex-1 p-4 bg-gradient-to-r from-[#E63329] to-[#d62d25] text-white rounded-lg border-2 border-[#E63329] shadow-md">
